# nikl-dict — data license

**Source:** 국립국어원 표준국어대사전 (Standard Korean Dictionary), via the key-free GitHub mirror
spellcheck-ko/korean-dict-nikl (stdict shards).
**License:** CC BY-SA 2.0 KR (저작자표시-동일조건변경허락 2.0 대한민국). Commercial use OK; attribution +
ShareAlike required.
...
- Source URL: https://github.com/spellcheck-ko/korean-dict-nikl (stdict/)
- Retrieved: 2026-06-19.
- Deed: https://creativecommons.org/licenses/by-sa/2.0/kr/
